...
describe("Vector", () => {
    ...
    test('adding two vectors', () => {
        let vector_a = new Vector(1,2)
        let vector_b = new Vector(-5,1)
    ...
    test('positively scaling vectors', () => {
        let vector = new Vector(1,4.5).scale(10)
    ...
    test('negatively scaling vectors', () => {
        let vector = new Vector(4,15).scale(-3)
    ...
    test('rotating vectors anticlockwise', () => {
        let vector = new Vector(1,0).rotate(Math.PI/2)
    ...
    test('dot product', () => {
        ...
        expect(vector.dot(new Vector(0,1))).toBe(0)
    })
})
